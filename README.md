...
The IBMQ calibration reports from the day of the implementations 08.04.2026 can be found at [calibration_reports](https://github.com/lucas-tsunaki/quantum_vault/tree/main/calibration_reports).

This application has dependencies on NumPy version 2.3.1, Qiskit version 2.1.0 and Qiskit IBM Runtime version 0.45.0.
Due to Qiskit's fast development, the code is not guaranteed to work with newer versions as the ones specified above. 

If you used the code provided here, please cite this repository with the data from [CITATION.cff](https://github.com/lucas-tsunaki/quantum_vault/blob/main/CITATION.cff) and the accompanying paper [arXiv:2605.03564](https://arxiv.org/abs/2605.03564).